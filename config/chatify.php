...
return [
    ...
    */
    ...
    'name' => env('CHATIFY_NAME', 'Workplace Messages'),
    ...
    */
    'routes' => [
        ...
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth', '2fa']),
    ...
    */
    'attachments' => [
        ...
        'allowed_files' => (array) ['zip','rar','txt','docx','xlsx','pdf','sql','json','pptx'],
