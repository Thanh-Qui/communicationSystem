    ...
    <div class="content-wrapper">
      <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h1 class="card-title folder-list" style="font-size: 24px">
                        <a href="{{ route('myStorage') }}">
                            My drive
                        </a>

                        {{-- gọi dữ liệu trong mảng --}}
                        @foreach($breadcrumbs as $crumb)
                            <span> > </span> <a href="{{ route('folders.show', $crumb['id']) }}">{{ $crumb['name'] }}</a>
                        @endforeach
                      </h1>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="dropdown me-2">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownType">
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId]) }}">
                                  All
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'folders']) }}">
                                  <i class="fa-solid fa-folder me-2" style="color: #f1c40f"></i> Folders
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'documents']) }}">
                                  <i class="fa-solid fa-file-word me-2" style="color: #0652DD"></i> Documents
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'pdfs']) }}">
                                    <i class="fa-solid fa-file-pdf me-2" style="color: #EA2027"></i> PDFs
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'excel']) }}">
                                  <i class="fa-solid fa-file-excel me-2" style="color: #009432"></i> Excel
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'images']) }}">
                                    <i class="fa-solid fa-file-image me-2" style="color: #EA2027"></i> Photos & images
                                </a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'type' => 'videos']) }}">
                        ...
                        <div class="dropdown me-2">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownModified">
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId]) }}">All</a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'filter' => 'today']) }}">Today</a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'filter' => 'last_7_days']) }}">Last 7 days</a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'filter' => 'last_30_days']) }}">Last 30 days</a>
                                <a class="dropdown-item" href="{{ route('folders.show', ['id' => $folderId, 'filter' => 'last_year']) }}">Last year</a>
                            </div>
                        </div>
                        ...
                        <form id="uploadForm" action="{{ route('file.upload') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="folderId" name="folder_id" value="{{ $folderId ?? 0 }}">
                          ...
                          @if (isset($items) && $items->isNotEmpty())
                              @foreach ($items as $item)
                                  ...
                                  >
                                      ...
                                      <td>{{ $userNames[$item->user_id] ?? 'Unknown' }}</td>
                                      ...
                                      <td>
                                        <div class="dropstart text-drive-span">
                                          <a class="mdi mdi-dots-vertical dot-func" style="color: black; font-size: 16px" href="#"
